local function get_range(buf, start, stop)
  ...
  local function _3_()
    local _2_ = start
    if ((_G.type(_2_) == "table") and (nil ~= (_2_)[1]) and (nil ~= (_2_)[2])) then
      local row = (_2_)[1]
      local col = (_2_)[2]
