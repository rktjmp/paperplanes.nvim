 ...
 local function _3_() local _2_ = start if ((_G.type(_2_) == "table") and (nil ~= (_2_)[1]) and (nil ~= (_2_)[2])) then local row = (_2_)[1] local col = (_2_)[2] return {row, math.min(10000, (col + 1))} elseif (nil ~= _2_) then local line = _2_ return {line, 1} else return nil end end local _local_1_ = _3_() local start_line = _local_1_[1] local start_col = _local_1_[2]


 local function _7_() local _6_ = stop if ((_G.type(_6_) == "table") and (nil ~= (_6_)[1]) and (nil ~= (_6_)[2])) then local row = (_6_)[1] local col = (_6_)[2] return {row, math.min(10000, (col + 1))} elseif (nil ~= _6_) then local line = _6_ return {line, -1} else return nil end end local _local_5_ = _7_() local stop_line = _local_5_[1] local stop_col = _local_5_[2]
